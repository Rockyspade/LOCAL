...
public class ReExamTable extends Activity{
	List<table> list;
	private String cnum;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		TableService t=new TableService(ReExamTable.this);
		list=t.getScrollData1();
			...
			if(!list.isEmpty()){
				...
				new Builder(ReExamTable.this).setMessage("无此信息").show();
			}
		}
}
